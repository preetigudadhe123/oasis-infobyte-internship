...
FONT1 = ("Georgia",16,'italic')
FONT2 = ("Georgia",14)
FONT3 = ("Georgia",10)

BG = "black"
BG_BUTTON = "light green"
FG = "white"
...
root.geometry("570x280+650+200")

lab1 = Label(root, text="RANDOM PASSWORD GENERATOR",font=FONT1,foreground = "cyan", bg=BG)
lab1.pack(pady=10)
